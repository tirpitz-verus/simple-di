 ...
 */
public class ProducedBeanProvider extends BeanProviderEntity implements CodeGenerated {
     ...
     */
    public ProducedBeanProvider(BeanEntity producedBean, BeanEntity beanProducer, String producerMethod) {
